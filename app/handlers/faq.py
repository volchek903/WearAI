...
async def faq_open(cb: CallbackQuery) -> None:
    ...
    text = (
        ...
        "8) <b>Реферальная программа</b>\n"
        "— Приглашай друзей по своей ссылке формата: <code>/start ref_ВАШ_TG_ID</code>.\n"
        "— За <b>10</b> приглашённых пользователей вы получаете <b>подписку Orbit</b>.\n"
        "— За <b>50</b> приглашённых пользователей вы получаете <b>подписку Nova</b>.\n"
        "— Если текущая подписка хуже/такая же/дешевле — она заменяется новой.\n\n"
        "9) <b>Как получить бесплатную генерацию?</b>\n"
        "— В разделе <b>Доп. возможности → Как получить бесплатную генерацию</b>.\n"
        "— Промокоды можно получить в рассылке внутри бота или в нашем Telegram-канале: https://t.me/WearAIOfficial\n\n"
